    ...
    <div className="w-full mt-24 grid grid-cols-1 md:grid-cols-2 min-h-[400px]">
      ...
      <div className="flex flex-col justify-center px-6 md:px-10 py-10 bg-[#8B5E3C]">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <p className="text-white/60 text-xs md:text-sm mb-1">Telefon</p>
            <p className="text-white text-sm md:text-base font-medium">
              +998 90 123 45 67
            </p>
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-white/60 text-xs md:text-sm mb-1">Manzil</p>
            <p className="text-white text-sm md:text-base font-medium">
              Toshkent, Uzbekiston
            </p>
          </div>
      ...
      <div className="flex flex-col justify-center px-6 md:px-10 py-10 bg-[#f5f0e8]">
        ...
        <input
          ...
          className="w-full mb-6 px-4 py-3 rounded-full border border-[#c9b99a] bg-white text-gray-700 text-sm md:text-base outline-none focus:border-[#8B5E3C] transition"
        />
